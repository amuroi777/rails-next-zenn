...
RSpec.describe "Api::V1::Current::Articles", type: :request do
  describe "GET api/v1/current/articles" do
    ...
    context "ログインユーザーに紐づく articles レコードが存在する場合" do
  ...
  describe "POST api/v1/current/articles" do
    ...
    context "ログインユーザーに紐づく未保存ステータスの記事が0件の場合" do
      it "未保存ステータスの記事が新規作成されること" do
    ...
    context "ログインユーザーに紐づく未保存ステータスの記事が1件の場合" do
